   ...
   <body>
      <nav class="navbar bg-dark">
         ...
         <ul>
            ...
            <li>
               <a href="#"><i class="fa fa-user-check"></i> <span class="ml-1">Lecturer Login</span> </a>
            </li>
            <li>
      ...
      <section class="container">
         ...
         <h1 class="large text-primary">Lecturer Login</h1>
         <p class="lead"><i class="fas fa-user"></i> Login to your account</p>

         <form action="{{ route('lecturer.check') }}" method="post" autocomplete="off" class="form">
                @if (Session::get('fail'))
        ...
        @csrf
            ...
            <div>
              <br>
                <a href="{{ route('lecturer.forgot.password.form') }}">Forgot password</a>
                <br>
                <br>
            </div>
