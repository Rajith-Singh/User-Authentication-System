   ...
   <body>
      <nav class="navbar bg-dark">
         ...
         <ul>
            ...
            <li>
               <a href="#" title="Assignment"><i class="fas fa-tasks"></i> <span class="hide-sm ml-1">Assignments</span></a>
            </li>
            <li>
      ...
      <section class="container">
         ...
         <div class="dash-buttons">
            ...
            <a href="#" class="btn"> <i class="fas fa-book text-primary"></i> Create Assignments </a>
         </div>
