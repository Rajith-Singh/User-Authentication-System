   ...
   <body>
      <nav class="navbar bg-dark">
         ...
         <ul>
            ...
            <li>
               <a href="dashboard.html" title="Dashboard"><i class="fas fa-user"></i> <span class="hide-sm ml-1">Assignment</span></a>
            </li>
            <li>
      ...
      <section class="container">
         ...
         <p class="lead"><i class="fas fa-User"></i> Hi {{ Auth::guard('student')->user()->fullname }}. Welcome to the WorkZen</p>
         <div>
